...
<body>
	...
	<main>
		...
		<h2 style="color: #FFFFFF;">Update Manager</h2>
		<br><br>	
			<form action="/usersearchformanagerupdate" method="get">
  			...
  			<table style="width:80%" align = "center">
  				<tr><td>FirstName</td>
  					...
  					<td>Zip Code</td>
  					<td>City</td>
  					<td> Present Manager</td>
  					<td> Update Manager</td></tr></tr>
  				<c:forEach items="${customers}" var="user">
  					<tr><td><c:out value="${user.firstName}"/></td>
        				...
        				<td><c:out value="${user.managerId}"/></td>
